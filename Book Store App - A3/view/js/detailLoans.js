$(document).ready(function(){
   /**
    ...
    $("#show-open-loans").click(function (event) {
        event.preventDefault();
        $("#list-loans").empty();
        /**  Assembling the table everytime the button is clicked.
            This will make sure that if things are added, deleted or modified in the other tab,
    ...
    $("#show-close-loans").click(function (event) {
        event.preventDefault();
        $("#list-loans").empty();
        /**  Assembling the table everytime the button is clicked.
            This will make sure that if things are added, deleted or modified in the other tab,
    ...
    $(".show-loan-buttons").click(function (index) {
        // get the clicked id
        $("button").removeClass("activeShowLoan")
        $(this).addClass("activeShowLoan")
    });
});